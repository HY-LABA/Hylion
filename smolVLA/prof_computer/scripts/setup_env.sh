...
echo "   3. dry-run:      cd ${SMOLVLA_DIR}/dgx/finetune/leftarm_v2 && python run_train.py train --pass 2a --dry-run"
echo "   4. smoke test:   train_config.yaml 의 steps=100 임시 변경 후 실행 — VRAM peak / 누수 측정"
echo "=========================================================="
