...
작업 시작 전 다음 스킬 파일을 Read:
- `.claude/skills/harness-engineering-principles/SKILL.md` — OpenAI harness engineering 평가 프레임워크 (10 원칙 + 우리 시스템의 알려진 보강 후보 10개)

본 스킬은 분석의 기준을 제공한다 — 각 anomaly 가 10 원칙 중 어느 것 위반인지 매핑, 갱신 제안을 어디에서 도출할지 가이드.
