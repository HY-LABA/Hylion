...
| `s1` | 35 GiB | +10 GiB | 04_leftarmVLA / 06_biarm 1차 |
| `s3` | 65 GiB | +10 GiB | 06_biarm 2차 (VLM 풀 학습) |
...
### 9.6 04_leftarmVLA 실 학습 진입 시 운영 절차 (예정)
...
03_smolvla_test_on_orin 마일스톤에서 latency 측정 + RTC 활성화 검토 (07_biarm_deploy 단계).
