...
| 경로 | 변경 종류 | 한 줄 요약 |
|---|---|---|
| `docs/storage/11_demo_site_mirroring.md` | A (신규) | 시연장 미러링 가이드 전체 (§0~§7, 246줄) |
...
`docs/storage/11_demo_site_mirroring.md` 를 신규 작성했다. 본 문서는 시연장을 DataCollector 인근에
...
- 11_demo_site_mirroring.md §5 grep "draccus" 및 "TODO-D3" 메모 존재 확인
- §1~§4 변경 X 확인
