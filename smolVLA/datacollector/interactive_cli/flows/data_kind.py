...
레퍼런스:
  - D1 §3 학습 종류 옵션 후보 (12_datacollector_cli_flow.md §3)
  - svla_so100_pickplace 사전학습 태스크: 07b §1-5 실측값
    "Pick up the object and place it in the target area." (옵션 1 — 최근접 분포)
  - tokenizer_max_length=48 (configuration_smolvla.py:60) — 48토큰 이내 영문 자연어 준수
"""
...
def flow5_select_data_kind() -> DataKindResult | None:
    ...
    spec line 55: "어떤 학습 데이터를 모을건가요?" + 5개 옵션 중 선택
