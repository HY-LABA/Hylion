...
echo ""
echo " 실행 예시:"
echo "   python ${SMOLVLA_DIR}/tests/smoke_test.py    # venv/CUDA/import 검증"
echo "   ${SMOLVLA_DIR}/scripts/run_inference_leftarm_v2.sh zero-shot task1    # base ckpt zero-shot 추론 (leftarm_v2 era)"
echo "══════════════════════════════════════════════════════"